function poem () {
    mySprite.sayText("AHEM", 5000, true)
    pause(5000)
    THE()
}
function on_start () {
    music.play(music.createSong(assets.song`fathers day`), music.PlaybackMode.LoopingInBackground)
    ...
    scaling.scaleByPixels(mySprite, 20, ScaleDirection.Vertically, ScaleAnchor.Middle)
    scaling.scaleByPercent(mySprite, 50, ScaleDirection.Uniformly, ScaleAnchor.Middle)
    for (let index = 0; index < 4; index++) {
        mySprite.sayText("PRESS A TO BEGIN THE POEM", 2000, true)
    }
}
...
function THE2 () {
    mySprite.sayText("You make me laugh You love, you care,", 5000, true)
    pause(5000)
    mySprite.sayText("Your love is always everywhere", 5000, true)
    pause(5000)
    mySprite.sayText("When I need you You're always there,", 5000, true)
    pause(5000)
    mySprite.sayText("You give me room To learn and grow", 5000, true)
    pause(5000)
    mySprite.sayText("And I just want To let you know...", 5000, true)
    pause(5000)
    mySprite.sayText("That you're the best And I love you", 5000, true)
    pause(5000)
    mySprite.sayText("And i'm so glad You love me too!", 5000, true)
    pause(5000)
    mySprite.sayText("AND NOW I WILL DISAPEAR! ", 5000, true)
    pause(5000)
    sprites.destroy(mySprite, effects.disintegrate, 500)
    game.gameOver(true)
}
function THE () {
    mySprite.sayText("A FATHERS DAY POEM", 5000, true)
    pause(5000)
    THE2()
}
